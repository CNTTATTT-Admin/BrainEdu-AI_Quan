    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm animate-fade-in">
      <div className="bg-white w-full max-w-xl rounded-2xl border border-slate-200 shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div>
            <h2 className="text-sm font-bold text-slate-900">Tạo khóa học hệ thống</h2>
            <p className="text-[11px] text-slate-500">Nhập đầy đủ thông tin để khởi tạo cấu trúc lớp học mới.</p>
          </div>
          <button
            onClick={onClose}
